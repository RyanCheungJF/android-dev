...
import com.example.crime.databinding.ListItemCrimeBinding
...
// recycler view doesn't create view holders. instead, responsibility is of the adapter
// an adapter is a controller object that sits between recycler view and data
